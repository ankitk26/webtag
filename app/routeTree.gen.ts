...
import { Route as ProtectedBookmarksImport } from './routes/_protected/bookmarks'
...
const ProtectedBookmarksRoute = ProtectedBookmarksImport.update({
  id: '/bookmarks',
  path: '/bookmarks',
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_protected/bookmarks': {
      ...
      path: '/bookmarks'
      fullPath: '/bookmarks'
      preLoaderRoute: typeof ProtectedBookmarksImport
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/_protected/bookmarks": {
      "filePath": "_protected/bookmarks.tsx",
      "parent": "/_protected"
    },
    "/auth/confirm": {
